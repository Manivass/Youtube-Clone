...
const Header = () => {
  ...
  return (
    <div className="grid grid-flow-col  p-2 mb-3 shadow-lg shadow-gray-200  h-25 ">
      <div to="/search" className="flex  gap-2 my-auto ">
        <IoMdMenu
      ...
      <div className="w-[50%] col-span-10  p-2 -translate-y-1 mx-auto h-15 my-auto">
            ...
            <ul>
              {suggestion.map((related, index) => (
                <li key={index}>
                  <Link
                    to={`/search?q=${related}`}
                    className="flex gap-2 py-1 px-2 hover:bg-gray-100 cursor-pointer shadow-xs"
                  >
      ...
      <div className="text-4xl -translate-y-2.5 my-auto">
